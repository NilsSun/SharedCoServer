...
public class FileIO {
    ...
    public JSONArray readFile(String filename) {
        ...
        try {
            ...
            jsonOSource.size();
            System.out.println("jsonObject.size(): " + jsonOSource.size());
            
            System.out.println("name: " + jsonOSource.get("name"));
            System.out.println("content: " + jsonOSource.get("content"));
            
            jsonArray = (JSONArray) jsonOSource.get("content");
            System.out.println("contentList size: " + jsonArray.size());
