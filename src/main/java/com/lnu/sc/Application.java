...
public class Application extends SpringBootServletInitializer {
	...
	@Value("${keystore.pass}") private String keystorePass;
        ...
        public static JSONArray collectionRelations = RepositoryData.getCollectionsRelations();
        
    public static void main(String[] args) {
        
        currentCollections.put("key", "/ilpnnqrs");
        currentCollections.put("name", "/hellocollection");
